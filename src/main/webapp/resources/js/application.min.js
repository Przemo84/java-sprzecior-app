...
$(document).ready(function () {
    resizeContent();
    $("#left").height() > $("#main").height() && $("#main").height() < $(window).height() && $("#left").addClass("full");
    $("#left").height() < $(window).height() && !$("#left").hasClass("force-full") && $("#left").removeClass("full");
    ...
    $(".content-remove").click(function (e) {
        ...
        bootbox.animate(!1);
        bootbox.confirm("Czy na pewno chcesz usunąć widget <strong>" + t.parents(".box-title").find("h3").text() + "</strong>?", "Anuluj", "Tak, usuń", function (e) {
            if (e) {
    ...
    $(".table-mail > tbody > tr").click(function (e) {
        var t = $(this),
            n = el.find(".table-checkbox > input");
