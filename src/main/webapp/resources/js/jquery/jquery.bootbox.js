...
var bootbox = window.bootbox || function (w, n) {
    ...
    var p = "en", t = "en", u = !0, s = "static", v = "", l = {}, g = {}, m = {
        setLocale: function (b) {
            ...
            return m.dialog(b, [{label: a, icon: g.CANCEL, "class": l.CANCEL, callback: h}, {
            ...
            }, d = m.dialog(q, [{label: a, icon: g.CANCEL, "class": l.CANCEL, callback: h}, {
                label: c,
                icon: g.CONFIRM,
                "class": l.CONFIRM,
                callback: function () {
