...
<div class="page-header">
    <div class="pull-left">
        <h1><fmt:message key="menu.other.users"/></h1>
    </div>
</div>
...
<div class="breadcrumbs">
    <ul>
        ...
        <li>
            <a href="<c:url value="${moduleBaseUrl}"/>"><fmt:message key="menu.other.users"/></a>
        </li>
    </ul>
...
<div class="row-fluid">
    <div class="span12">
                        ...
                        <table class="table table-hover table-nomargin table-striped table-bordered"
                            ...
                            <tr>
                                <th colspan="8">
                                    ...
                                    <button class="btn btn-primary" id="executeBtn" type="submit">
        ...
        <div class="pagination pagination-small">
            <div>
                <%--<tag:paginate page="${param.page}" offset="${param.size}" count="${count}" uri="${uri}" next="&#62;"--%>
                <%--previous="&#60;"/>--%>
