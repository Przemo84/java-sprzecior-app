...
public class UserAccountControllerAppTests {
    ...
    public void testChangePasswordFormAction() throws Exception {
        ...
        mockMvc.perform(get("/app/account/password"))
